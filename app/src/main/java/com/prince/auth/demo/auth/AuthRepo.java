...
import com.prince.auth.demo.BooksApp;
import com.prince.auth.demo.R;
import com.prince.auth.demo.auth.AuthException;
import com.prince.auth.demo.auth.AuthLoginListener;
...
import static com.prince.auth.demo.auth.AuthEvent.AUTH_CODE_EXCHANGE_FINISH;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_CODE_EXCHANGE_START;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_LOGIN_FAILURE;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_LOGIN_START;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_LOGIN_SUCCESS;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_LOGOUT_START;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_LOGOUT_SUCCESS;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_SERVICE_DISCOVERY_FINISH;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_SERVICE_DISCOVERY_START;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_USER_AUTH_FINISH;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_USER_AUTH_START;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_USER_INFO_FINISH;
import static com.prince.auth.demo.auth.AuthEvent.AUTH_USER_INFO_START;
...
public class AuthRepo {
    ...
    private void finishCodeExchange() {
        ...
        Log.i(TAG, "AccessToken: "+authState.getAccessToken());
        Log.i(TAG, "RefreshToken: "+authState.getRefreshToken());
